...
module.exports = function(grunt){
  ...
  files = {
    ...
    test: ['test/buster', 'test/lib/test-utils', 'test/helper/autoreload', 'test/tests/watch.test', 'test/tests/autoreload.test', 'test/tests/command.test', 'test/tests/websocket.test', 'test/tests/example.test'],
    testData: ['test/data'],
    gruntjs: ['Gruntfile']
  };
  esteFiles = {
  ...
  [['config', ['livescript:gruntjs', 'copy:gruntjs', 'reload']], ['clean-all', ['clean:test', 'clean:src', 'clean:tmp']], ['src-debug', ['livescript:src', 'livescript:bin', 'copy:src', 'copy:bin', 'chmod']], ['test', ['livescript:test', 'copy:test', 'copy:testTmp', 'buster']], ['default', ['esteWatch']], ['build', ['livescript:src', 'livescript:bin', 'uglify:src', 'uglify:bin', 'template:readme', 'chmod']], ['release', ['build', 'test', 'clean:test', 'clean:tmp']], ['release-git', ['build', 'test', 'clean-all']]]);
};
